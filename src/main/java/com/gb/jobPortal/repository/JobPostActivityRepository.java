...
import com.gb.jobPortal.entity.IRecruiterJobs;
...
public interface JobPostActivityRepository extends JpaRepository<JobPostActivity, Integer> {
    ...
    List<JobPostActivity> search(@Param("date") ZonedDateTime date,
                                 @Param("job") String job, @Param("location") String location,
                                 @Param("type") List<String> type, @Param("remote") List<String> remote);
}
