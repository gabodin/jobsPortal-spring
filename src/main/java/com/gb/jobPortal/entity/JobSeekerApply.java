...
public class JobSeekerApply implements Serializable {
    ...
    public JobSeekerApply(Integer id, JobSeekerProfile userId, JobPostActivity job, ZonedDateTime applyDate, String coverLetter) {
        this.id = id;
        this.userId = userId;
        this.job = job;
    ...
    public void setJob(JobPostActivity jobPostActivity) {
        this.job = jobPostActivity;
    }
